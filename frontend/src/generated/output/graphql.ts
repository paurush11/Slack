...
export type MeQuery = { __typename?: 'Query', Me?: { __typename?: 'Member', username: string, lastName: string, email: string, _id: string, firstName: string, channels: Array<{ __typename?: 'Channel', _id: string, Name: string, IconName: string, Description: string }>, messagesReceived?: Array<{ __typename?: 'DirectMessage', _id: string }> | null } | null };
